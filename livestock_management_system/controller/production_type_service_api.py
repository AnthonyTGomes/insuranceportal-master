...
from livestock_management_system.helper.livestock_management_helper_class import get_asset_production_records
...
class ProductionTypeServiceAPIView(APIView):
    ...
    def get(self, request):
        try:
            ...
            result = get_asset_production_records(record)  # validation happens here
